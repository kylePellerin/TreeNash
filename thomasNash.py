...
#     if prev_node == None:
#         neigbor_actions = []
#         node_threshold = threshold*len(G.neighbors(curr_node))
#         node_dict = {}

#         # Recurse on neighbors
#         for neighbor in G.neighbors(curr_node):
#             downstream(G, neighbor, curr_node)
#             actions = G.nodes[neighbor]['dict'].keys()
#             neigbor_actions.append(actions)

#         # Try to make curr_node 0
#         neigbor_actions_0 = []
#         for neighbor in neigbor_actions:
#             neighbor_0 = []
#             for combination in neighbor:
#                 if combination[1] == 0:
#                     neighbor_0.append(combination[1])
#             neigbor_actions_0.append(neighbor_0)
        
#         for i in range(2**len(G.neighbors(curr_node))):
#             binary = bin(i)[2:]
#             curr_moves = []
#             works = True
#             for j, character in enumerate(binary):
#                 if int(character) in neigbor_actions_0[j]:
#                     curr_moves.append(int(character))
#                 else:
#                     works = False
#             if works and sum(curr_moves) < node_threshold:
#                 if 0 in node_dict.keys():
#                     node_dict[0] = {curr_moves}
#                 else:
#                     node_dict[0].add(curr_moves)
        
#         # Try to make curr_node 1
#         neigbor_actions_1 = []
#         for neighbor in neigbor_actions:
#             neighbor_1 = []
#             for combination in neighbor:
#                 if combination[1] == 1:
#                     neighbor_1.append(combination[1])
#             neigbor_actions_1.append(neighbor_1)
...
#             works = True
#             for j, character in enumerate(binary):
#                 if int(character) in neigbor_actions_1[j]:
#                     curr_moves.append(int(character))
#                 else:
#                     works = False
#             if works and sum(curr_moves) >= node_threshold:
#                 if 0 in node_dict.keys():
#                     node_dict[1] = {curr_moves}
#                 else:
#                     node_dict[1].add(curr_moves)
...
#         for i in range(2**(len(G.neighbors(curr_node))-1)):
#             binary = bin(i)[2:]
#             curr_moves = []
#             works = True
#             for j, character in enumerate(binary):
